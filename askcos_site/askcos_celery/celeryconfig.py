...
imports = [
    ...
    'askcos_site.askcos_celery.contextrecommender.cr_neural_v2_worker',
...
task_routes = {
    ...
    'askcos_site.askcos_celery.contextrecommender.cr_neural_v2_worker.*': {'queue': 'cr_neural_v2_worker'},
