...
imports = [
    ...
    'askcos_site.askcos_celery.contextrecommender.cr_network_v2_worker',
...
task_routes = {
    ...
    'askcos_site.askcos_celery.contextrecommender.cr_network_v2_worker.*': {'queue': 'cr_network_v2_worker'},
